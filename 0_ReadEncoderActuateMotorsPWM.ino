...
#define outputB 3  // Channel B pin
...
// Motor A pins
const int mA_pinIn1 = 5;       // Direction control pin 1
const int mA_pinIn2 = 6;       // Direction control pin 2
const int mA_pinEnA = 3;       // Enable pin (controls speed using PWM)
...
void loop() {
  ...
  if (positionInDegrees_m2 > 360.0 || positionInDegrees_m2 < -360.0) {
    ...
    positionInDegrees_m2 = 0.0; // Reset calculated angle
